# Documentação Técnica — Site KonvertAI

> Versão: 1.0.0
> Data: 05/06/2026
> Deploy: https://konvertai-site.vercel.app
> Repositório: https://github.com/konvertai/konvertai-site
...
Landing page de alta conversão para a agência de IA **KonvertAI**, focada em gerar leads via WhatsApp e formulário. Site estático, sem backend, otimizado para performance e SEO.
...
│
├── Docs/
│   ├── Site KonvertAI - Planejamento.md
│   └── Documentacao_Tecnica_Site_KonvertAI.md (este arquivo)
│
├── html/                   # Arquivos fonte originais (não vão pro deploy)
│   ├── K.png               # PNG original do K (referência)
│   ├── K+konvertai.png     # PNG original da logo
│   └── ...
│
...
### Meta Tags
- Title: "KonvertAI — Agentes de IA para WhatsApp | Atendimento Automático 24h"
