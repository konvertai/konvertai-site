# Site KonvertAI — Planejamento de Desenvolvimento
> Versão: 1.0 | Criado: 05/06/2026
> Status: Em planejamento
> Deploy: Vercel (auto-deploy via GitHub)
> Domínio: konvertai.com.br (Cloudflare DNS)

---

## 1. OBJETIVO

Landing page de alta conversão para a agência de IA **KonvertAI**, com foco em:
...
- "Empresas que já confiam na KonvertAI"
...
### 6.5 Solução
- H2: "A KonvertAI resolve isso em minutos"
...
| Solução | "A KonvertAI resolve isso em minutos" |
